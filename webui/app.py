...
async def seiten_nicht_aufheben(request: Request, call_next):
    ...
    **Der Fall aus dem September 2026, und er kostete eine Stunde
    Suche:** Nach einem Update stand im Befehlsblock ein schwarzer Balken
    ohne Text -- kopieren liess sich der Befehl trotzdem. Es war die alte Seite
...
# Wiedererkennen, keine Beschreibung.** Im September 2026 festgelegt: Wer
...
# langen Seiten unter Quellen und Clients jedes Mal. Im August 2026 fiel
# auf, dass die Marke an mehreren Stellen fehlte.
#
...
def serverhealth(request: Request, meldung: str = "", art: str = ""):
    ...
    return html.TemplateResponse(
        ...
        _rahmen(
            ...
            # Worauf dieser Server laeuft -- aus derselben Quelle wie der
            # Fehlerbericht, damit in einer Meldung nicht ein anderer
            # Kernel steht als hier. Gepuffert, weil diese Seite offen
            # stehen bleibt; den Takt nennt die Karte selbst.
            serverdetails=bericht.karte(),
        ),
    )
