...
Als Betriebssystem **der Maschine** sind **Debian 12 und 13**,
**Ubuntu 26.04** sowie **Raspberry Pi OS 13 in 64 Bit** getestet: dort ist
der ganze Weg durchgelaufen — installiert, ein Abbild geholt, ein Rechner
davon gestartet.

**Unterstützt, aber noch nicht durchgespielt** sind Ubuntu 22.04 und
24.04 sowie Raspberry Pi OS in 32 Bit. Verwandte Systeme derselben Familie —
